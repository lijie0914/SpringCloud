package com.liuniukeji.springcloud.eureka_producer.utils;
    ...
    private static List<Map<String, Object>> setSearchResponse(SearchResponse searchResponse, String highlightField) {
        ...
        for (SearchHit searchHit : searchResponse.getHits().getHits()) {
            ...
            if (StringUtils.isNotEmpty(highlightField)) {
                ...
                HighlightField searchHitHighlightField = highlightFields.get(highlightField);
                Text[] text = null;
                if (null != searchHitHighlightField) {
                    text = searchHitHighlightField.getFragments();
                }
